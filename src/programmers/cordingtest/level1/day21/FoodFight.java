...
public class FoodFight {
    ...
    public static void main(String[] args) {
        ...
        /* repeat 함수 예시 */
        //foodFight.repeat("hello");

        String result = foodFight.solution(food);
        System.out.println("대회를 위한 음식의 배치: "+result);
    }
    ...
    public String solution(int[] food) {
        ...
        // StringBuilder에 추가된 음식에 물(0)과 reverse된 문자열 더하기
        String answer = sb + "0";
        answer += sb.reverse();
    ...
    public void repeat(String str) {
        System.out.println("0: "+str.repeat(0));    // 빈값
        System.out.println("1: "+str.repeat(1));    // hello
        System.out.println("2: "+str.repeat(2));    // hellohello
        System.out.println("3: "+str.repeat(3));    // hellohellohello
    }
}
