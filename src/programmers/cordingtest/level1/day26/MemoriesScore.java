...
public class MemoriesScore {
    ...
    public static void main(String[] args) {
        // 입출력 예
        String[] name = {"may", "kein", "kain", "radi"};                                                                            // 그리워하는 사람의 이름을 담은 문자열 배열
        int[] yearning = {5, 10, 1, 3};                                                                                             // 각 사람별 그리움 점수를 담은 정수 배열
        String[][] photo = {{"may", "kein", "kain", "radi"},{"may", "kein", "brin", "deny"}, {"kon", "kain", "may", "coni"}};       // 각 사진에 찍힌 인물의 이름을 담은 이차원 문자열 배열
        ...
        int[] result = memoriesScore.solution(name, yearning, photo);
        System.out.println("사진들의 추억 점수: ");
