...
public class GetReport {
    /*
        ...
        무지가 개발하려는 시스템은 다음과 같습니다. 각 유저는 한 번에 한 명의 유저를 신고할 수 있습니다.
        ...
        |   "neo"  |        없음	       |       없음        |
        ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
        각 유저별로 신고한 아이디와 정지된 아이디를 정리하면 다음과 같습니다.
    ...
    public static void main(String[] args) {
        // 입출력 예
        String[] id_list = {"muzi", "frodo", "apeach", "neo"}; // 이용자의 ID가 담긴 문자열 배열 id_list
        // 각 이용자가 신고한 이용자의 ID 정보가 담긴 문자열 배열 report
        String[] report = {"muzi frodo","apeach frodo","frodo neo","muzi neo","apeach muzi"};
        int k = 2; // 정지 기준이 되는 신고 횟수 k
        ...
        int[] result = getReport.solution(id_list, report, k);
