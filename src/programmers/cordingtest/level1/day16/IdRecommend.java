package programmers.cordingtest.level1.day16;
...
public class IdRecommend {
    ...
    public static void main(String[] args) {
        ...
        String result = idRecommend.solution(new_id);
    ...
    /*
        ...
        아주 기본적인 차이는 String은 immutable(불변), StringBuffer는 mutable(변함)에 있다.

        StringBuffer/StringBuilder는 String과 다르게 문자열 연산 등으로 기존 객체의 공간이 부족하게 되는 경우,
    ...
    public String solution1(String new_id) {
        ...
        // boolean contains(CharSequence s) : 대상 문자열에 특정 문자열이 포함되어 있는지 확인하는 함수
        // String replace(CharSequence target, CharSequence replacement) : 특정 문자열을 원하는 문자열로 치환하는 함수
        ...
        // String substring(int index) : index 위치를 포함하여 이후 문자열을 리턴
        String step4 = step3;
        if (step4.length() > 0) {
            if (step4.charAt(0) == '.') {                           // 처음
                step4 = step4.substring(1, step4.length());
            }else if (step4.charAt(step4.length() - 1) == '.') {    // 끝
