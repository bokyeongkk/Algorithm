...
public class ColaProblem {
    ...
    public static void main(String[] args) {
        // 입출력 예
        int a = 2;      // 콜라를 받기 위해 마트에 주어야 하는 병 수 a
        int b = 1;      // 빈 병 a개를 가져다 주면 마트가 주는 콜라 병 수 b
        int n = 20;     // 상빈이가 가지고 있는 빈 병의 수 n
        ...
        int result = colaProblem.solution1(a, b, n);
