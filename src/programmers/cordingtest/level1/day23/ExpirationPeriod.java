...
public class ExpirationPeriod {
    /*
        ...
        첫 번째 2021.05.02 수집된 개인정보는 A약관에 의해 2021년 11월 1일까지 보관 가능하며, 유효기간이 지났으므로 파기해야 할 개인정보입니다.
        두 번째 2021.07.01 수집된 개인정보는 B약관에 의해 2022년 6월 28일까지 보관 가능하며, 유효기간이 지나지 않았으므로 아직 보관 가능합니다.
        세 번째 2022.02.19 수집된 개인정보는 C약관에 의해 2022년 5월 18일까지 보관 가능하며, 유효기간이 지났으므로 파기해야 할 개인정보입니다.
        네 번째 2022.02.20 수집된 개인정보는 C약관에 의해 2022년 5월 19일까지 보관 가능하며, 유효기간이 지나지 않았으므로 아직 보관 가능합니다.
    ...
    public static void main(String[] args) {
        // 입출력 예
        String today = "2022.05.19";                                                                // 오늘 날짜
        String[] terms = {"A 6", "B 12", "C 3"};                                                    // 약관의 유효기간
        String[] privacies = {"2021.05.02 A", "2021.07.01 B", "2022.02.19 C", "2022.02.20 C"};      // 수집된 개인정보의 정보
        ...
        int[] result = expirationPeriod.solution(today, terms, privacies);
        System.out.println("파기해야 할 개인정보 번호:");
