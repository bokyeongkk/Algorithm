...
public class Process {
    ...
    public static void main(String[] args) {
        // 입출력 예
        int[] priorities = {2, 1, 3, 2};    // 프로세스의 중요도 순서
        int location = 2;                   // 알고싶은 프로세스의 위치

        //int[] priorities = {1, 1, 9, 1, 1, 1};
        //int location = 0;

        Process process = new Process();
        int result = process.solution(priorities, location);
        System.out.println("해당 프로세스가 몇 번째로 실행되는지: "+result);
    }
