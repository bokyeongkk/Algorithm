...
public class ExpectedBracket {
    ...
    public static void main(String[] args) {
        ...
        int result = expectedBracket.solution2(N, A, B);
        System.out.println("몇 번째 라운드에서 만나는지: "+result);
    }
    ...
    public int solution1(int n, int a, int b)
    {
        ...
        while (a != b) {
            // A와 B가 같은 그룹에 속할 때까지 N을 2로 나누며, 라운드 수를 1씩 증가한다.
            a = (a + 1) / 2;
            b = (b + 1) / 2;
            answer++;
        }
        // A와 B가 같은 그룹에 속하게 되면, 현재 라운드 수를 반환한다.
    ...
    public int solution2(int n, int a, int b)
    {
        /*
            a = 4, b = 7 일때,
            a - 1 = 3(11), b - 1 = 6(110) 이 되면서(괄호는 비트값)
            xor 비트연산자로 결과가 101 되고 length값이 3이 된다.
         */
