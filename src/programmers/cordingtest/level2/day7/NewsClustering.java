...
public class NewsClustering {
    ...
    public static void main(String[] args){
        ...
        System.out.println("두 문자열의 자카드 유사도: "+result);
    }

    public int solution(String str1, String str2) {

        // 대문자와 소문자의 차이는 무시한다. -> 소문자로 만들기
        ...
        // 문자열을 두 글자씩 끊어서 다중집합의 원소로 만든다. (str1 -> list1)
        ...
        // 문자열을 두 글자씩 끊어서 다중집합의 원소로 만든다. (str2 -> list2)
        ...
        for (String s : list1) {
            // ArrayList.remove(Object o) : 인자와 동일한 객체를 리스트에서 삭제한다.
            if (list2.remove(s)) {
                // 교집합
                intersection.add(s);
            }
